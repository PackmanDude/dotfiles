...
function _timer_stop()
{
	...
	if [ $elapsed_time -ge 86400 ]; then
		formatted_timer="$((elapsed_time / 86400))d$((elapsed_time % 86400 / 3600))h$((elapsed_time % 3600 / 60))m$((elapsed_time % 60))±1s passed"
	elif [ $elapsed_time -ge 3600 ]; then
		formatted_timer="$((elapsed_time % 86400 / 3600))h$((elapsed_time % 3600 / 60))m$((elapsed_time % 60))±1s passed"
	elif [ $elapsed_time -ge 60 ]; then
		formatted_timer="$((elapsed_time % 3600 / 60))m$((elapsed_time % 60))±1s passed"
	else
		formatted_timer="${elapsed_time}±1s passed"
	fi
